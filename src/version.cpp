...
#ifndef SORA_CPP_SDK_VERSION
#define SORA_CPP_SDK_VERSION "internal-build"
#endif

#ifndef SORA_COMMIT_SHORT
#define SORA_COMMIT_SHORT "unknown"
#endif
...
std::string Version::GetLibwebrtcName() {
