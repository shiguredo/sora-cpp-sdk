...
## 4 ch のマイクで音声を送信できません

2 ch までのマイクのみをサポートしています。2 ch 以下のマイクをご利用ください。
4 ch マイクで音声が送信できない事象は ROG Flow 13、ROG Zephyrus G16 の内蔵マイクで確認しています。
この場合、別途 2 ch 以下のマイクを用意いただく必要があります。
