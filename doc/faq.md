...
2 ch 以下のマイクのみをサポートしています。利用しているマイクが 2ch 以下であるかを確認してください。

Windows のノートパソコンで搭載されているマイクデバイスによっては、マイクのチャンネル数が 4 ch であるために音声送信できないことがあります。
こちらでは ROG Flow 13、ROG Zephyrus G16 に搭載されているマイクが 4ch であるために音声送信ができない事象を確認しています。
この場合、別途 2ch 以下のマイクを用意していただく必要があります。
